...
def generate_all_html(list_notes):
    ...
    all_html = generate_html_header  # note: comment this out when running online!
    
    for section in list_notes:
        all_html = all_html + generate_section(section)
    
    # and finish by adding the required html closing tags
    all_html = all_html + generate_html_footer  # note: comment this out when running online!
